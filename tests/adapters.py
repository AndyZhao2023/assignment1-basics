...
def run_linear(
    ...
    # Create a Linear layer and set its weights
    linear = Linear(d_in, d_out)
    linear.weight.data = weights
    
    # Use the linear layer to transform the input
...
def run_embedding(
    ...
    # Create an Embedding layer with the correct parameter names
    embedding = Embedding(num_embeddings=vocab_size, embedding_dim=d_model)
    embedding.weight.data = weights
    
    # Use the embedding layer to get embeddings for token_ids
...
def run_rope(
    ...
    # Create RoPE module with given parameters
    rope = RotaryPositionalEmbedding(
        theta=theta,
        d_k=d_k,
        max_seq_len=max_seq_len,
...
def run_rmsnorm(
    ...
    # Create RMSNorm layer with given parameters
